...
static bool cte_is_error(struct ssdcache_c *sc, struct ssdcache_te * cte)
{
	unsigned long oldstate, num_sectors;
	enum cte_state tmpstate;
	int match = 0, i;
...
static bool cte_is_invalid(struct ssdcache_c *sc, struct ssdcache_te * cte)
{
	unsigned long oldstate, num_sectors;
	enum cte_state tmpstate;
	int match = 0, i;
